...
class _$ProductsStateTearOff {
  ...
  _Success success({required List<Product> products}) {
    return _Success(
      products: products,
    );
  }
...
/// @nodoc
class __$SuccessCopyWithImpl<$Res> extends _$ProductsStateCopyWithImpl<$Res>
...
class _$_Success implements _Success {
  const _$_Success({required this.products});
...
abstract class _Success implements ProductsState {
  const factory _Success({required List<Product> products}) = _$_Success;
