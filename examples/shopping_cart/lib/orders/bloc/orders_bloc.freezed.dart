...
class _$OrdersStateTearOff {
  ...
  _Success success({required List<Order> orders}) {
    return _Success(
      orders: orders,
    );
  }
...
class _$_Success implements _Success {
  const _$_Success({required this.orders});
...
abstract class _Success implements OrdersState {
  const factory _Success({required List<Order> orders}) = _$_Success;
...
/// @nodoc
class __$ErrorCopyWithImpl<$Res> extends _$OrdersStateCopyWithImpl<$Res>
